const ProductDetails = () => {
  return (
    <>
      ...
      <p className="text-[#696969]">
        Once your A Scent of Pine Forest candle is finished, let the wax cool
        completely. To remove leftover wax, place the jar in warm water — wipe
        away softened wax and compost if natural. Wash the glass jar with mild
        soap and reuse it for storage — spices, office supplies, or trinkets.
        The plastic lid can be recycled if facilities accept #5 plastics. If
        reuse isn&apos;t an option, follow local recycling guidelines. Every
        small step helps protect our planet, keeping it as fresh as the pine
        forests that inspired this scent.
      </p>
    </>
  );
};
